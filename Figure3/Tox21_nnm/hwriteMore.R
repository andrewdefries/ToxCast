...
Draw<-cbind(paste(nnm$names[nnm$index[,1]], ".smi.png", sep=""), paste(nnm$names[nnm$index[,2]], ".smi.png", sep=""), paste(nnm$names[nnm$index[,3]], ".smi.png", sep=""), paste(nnm$names[nnm$index[,4]], ".smi.png", sep=""))
...
##
colnames(mat)=c('#', 'name', 'Query compound', 'nnm1', 'nnm2','nnm3')##,'nnm5', 'nnm6','nnm7','nnm8','nnm9')
##
